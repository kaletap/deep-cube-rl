...
from kociemba.color import U, R, F, D, L, B, color_keys, colors
from kociemba.corner import URF, UFL, ULB, UBR, DFR, DLF, DBL, DRB, corner_values
from kociemba.edge import UR, UF, UL, UB, DR, DF, DL, DB, FR, FL, BL, BR, edge_values
